...
return [
    'header' => [
        'top_bar_message' => '50달러 이상 주문 시 무료 배송 | 지원 | 매장 찾기',
    ...
    'footer' => [
        ...
        'follow_us' => '팔로우하기',
        'footer_logo_alt' => 'Trigan 푸터 로고',
        'copyright' => '© 2025 Trigan Demo. 모든 권리 보유.',
        'powered_by' => 'Trigan Labs 제공',
    ],
    ...
    'product_detail' => [
        ...
        'no_reviews' => '이 상품에 대한 리뷰가 아직 없습니다.',
        'no_review_text' => '작성된 리뷰가 없습니다.',
        'average_rating' => '평균 평점',
        'days_ago' => '{1} :days일 전|[2,*] :days일 전',
        'description' => '설명',
        'reviews' => '리뷰',
        'add_to_cart' => '장바구니에 담기',
        'increase_quantity' => '수량 늘리기',
        'decrease_quantity' => '수량 줄이기',
        'selected_variant_not' => '선택한 옵션은 사용할 수 없습니다.',
        'fetch_variant_failed' => '옵션 가격을 가져올 수 없습니다.',
        'ajax_error' => '문제가 발생했습니다. 다시 시도해주세요.',
        'currency_symbol' => '통화',
    ...
    'cart' => [
        ...
        // Coupon section
        'coupon_heading' => '쿠폰',
        'coupon_placeholder' => '쿠폰 코드',
        'apply_coupon' => '쿠폰 적용',
        'remove_coupon' => '쿠폰 제거',

        // Toast messages
        'coupon_applied' => '쿠폰이 성공적으로 적용되었습니다!',
        'coupon_removed' => '쿠폰이 성공적으로 제거되었습니다!',
