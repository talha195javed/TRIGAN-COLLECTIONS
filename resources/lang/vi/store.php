...
return [
    ...
    'product_detail' => [
        ...
        'submit_review_title' => 'Gửi đánh giá của bạn',
        'review_optional' => 'Đánh giá (tùy chọn)',
        'submit_review_btn' => 'Gửi đánh giá',
        'please' => 'Vui lòng',
        'login' => 'Đăng nhập',
        'customer' => 'Khách hàng',
        'submit' => 'để gửi đánh giá.',
        'no_reviews_yet' => 'Chưa có đánh giá nào cho sản phẩm này.',
        'no_review_text' => 'Chưa có đánh giá được viết.',
        'day' => 'ngày',
        'days' => 'ngày',
        'ago' => 'trước',
        'average_rating' => 'Đánh giá trung bình',
        'variant_not_available' => 'Biến thể đã chọn không có sẵn.',
        'something_wrong' => 'Đã có lỗi xảy ra. Vui lòng thử lại.',
        'added_to_wishlist' => 'Đã thêm vào yêu thích ❤️',
        'removed_from_wishlist' => 'Đã xóa khỏi yêu thích 💔',
        'login_to_wishlist' => 'Vui lòng đăng nhập để quản lý sản phẩm yêu thích.',
        'review_already_submitted' => 'Bạn đã đánh giá sản phẩm này rồi.',
